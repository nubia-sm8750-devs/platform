...
#endif
#ifdef REPORT_FLIP_X
			x = 1504 - x;//tcm->input_dev_params.max_x - x;
#endif
#ifdef REPORT_FLIP_Y
...
static int syna_dev_create_input_device(struct syna_tcm *tcm)
{
	...
	input_set_abs_params(input_dev, ABS_MT_POSITION_X, 0, tcm_dev->max_y, 0, 0);
	input_set_abs_params(input_dev, ABS_MT_POSITION_Y, 0, tcm_dev->max_x, 0, 0);
