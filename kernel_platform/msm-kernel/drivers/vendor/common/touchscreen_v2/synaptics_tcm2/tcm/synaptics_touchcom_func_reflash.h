...
int syna_tcm_update_lockdown_config(struct tcm_dev *tcm_dev, struct image_info *image,
	unsigned int flash_write_delay_us, unsigned int fw_switch_delay_ms);
/*
 ...
 *    [ in] offset:                the specified offset of address
 *                                 set '0' in default
...
int syna_tcm_update_cs_config(struct tcm_dev *tcm_dev, unsigned char *cs_data,
	unsigned int cs_data_size, unsigned int offset, unsigned int flash_access_delay_us,
