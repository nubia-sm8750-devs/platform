...
static inline void ts_info(struct device *dev, const char *fmt, ...)
{
        va_list args;
        char str[256] = {0};
...
static inline void ts_err(struct device *dev, const char *fmt, ...)
{
        va_list args;
        char str[256] = {0};
...
static inline void ts_debug(struct device *dev, const char *fmt, ...)
{
        va_list args;
        char str[256] = {0};
