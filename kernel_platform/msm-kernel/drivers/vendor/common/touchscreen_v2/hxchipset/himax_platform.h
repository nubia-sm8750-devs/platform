...
#define HIMAX_DRIVER_NAME	"himax,hxcommon"
#define MAX_STR_LABLE_LEN	32
...
struct himax_platform_data {
    ...
    char avdd_name[MAX_STR_LABLE_LEN];
    char iovdd_name[MAX_STR_LABLE_LEN];
...
extern int himax_gpio_power_config(struct himax_ts_data *ts, struct himax_platform_data *pdata);
