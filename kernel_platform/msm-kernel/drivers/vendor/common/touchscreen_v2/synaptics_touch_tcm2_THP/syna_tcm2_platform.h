...
/* DEBUG_BUS_TRACE
 *         Open if willing print the trace of bus transaction.
 */
/* #define DEBUG_BUS_DATA_TRACE */

#ifdef DEBUG_BUS_DATA_TRACE
#define DEBUG_MAX_BUS_DATA_LENGTH_TO_DEBUG (300)
#endif
