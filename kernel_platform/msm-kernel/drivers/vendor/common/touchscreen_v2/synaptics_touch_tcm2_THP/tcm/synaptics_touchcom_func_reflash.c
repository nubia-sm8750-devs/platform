...
/*
 *  Request to read out data from the specified address from the flash memory.
 *
 * param
 *    [ in] tcm_dev:       the TouchComm device handle
...
/*
 *  Read the data of mtp area in the flash memory.
 *
 * param
 *    [ in] tcm_dev:      the TouchComm device handle
 *    [ in] reflash_data: data blob for reflash
...
/*
 *   Request to update the lockdown config from the image file to device.
 *
 * param
 *    [ in] tcm_dev:               the TouchComm device handle
 *    [ in] image:                 parsed data from image file
...
/*
 *   Request to write the data to the custom serialization area
 *
 * param
 *    [ in] tcm_dev:              the TouchComm device handle
...
/*
 *   Request to read data from the custom serialization area
 *
 * param
 *    [ in] tcm_dev:               the TouchComm device handle
...
/*
 *   Request to write data to the MTP area
 *
 * param
 *    [ in] tcm_dev:               the TouchComm device handle
 *    [ in] mtp_data:              custom data to write
 *    [ in] mtp_data_size:         size of given data
...
/*
 *   Request to read data from the MTP area
 *
 * param
 *    [ in] tcm_dev:               the TouchComm device handle
 *    [out] mtp_data:              buffer storing the custom serialization data
