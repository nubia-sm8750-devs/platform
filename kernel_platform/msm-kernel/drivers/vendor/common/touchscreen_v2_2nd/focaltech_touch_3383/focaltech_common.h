...
#define FTS_MAX_RETRIES_READ_BOOTID         3
...
#define FTS_DEBUG(fmt, args...) do { \
    pr_info("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
    tpd_save_last_log("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d):"fmt"\n", __func__, __LINE__, ##args);\
} while (0)

#define FTS_FUNC_ENTER() do { \
    pr_info("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d): Enter\n", __func__, __LINE__); \
    tpd_save_last_log("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d): Enter\n", __func__, __LINE__); \
} while (0)

#define FTS_FUNC_EXIT() do { \
    pr_info("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d): Exit\n", __func__, __LINE__); \
    tpd_save_last_log("[ZTE_LDD_TP_2nd][TPD_FTS_TS/D](%s,%d): Exit\n", __func__, __LINE__); \
} while (0)
...
#define FTS_INFO(fmt, args...) do { \
    pr_info("[ZTE_LDD_TP_2nd][TPD_FTS_TS/I](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
    tpd_save_last_log("[ZTE_LDD_TP_2nd][TPD_FTS_TS/I](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
} while (0)

#define FTS_ERROR(fmt, args...) do { \
    pr_err("[ZTE_LDD_TP_2nd][TPD_FTS_TS/E](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
    tpd_save_last_log("[ZTE_LDD_TP_2nd][TPD_FTS_TS/E](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
} while (0)
