...
#define FTS_TEST_DBG(fmt, args...) pr_info("[ZTE_LDD_TP_2nd][FTS_TS][TEST](%s,%d):"fmt"\n",  __func__, __LINE__, ##args)


#define FTS_TEST_FUNC_ENTER() pr_info("[ZTE_LDD_TP_2nd][FTS_TS][TEST](%s,%d): Enter\n", __func__, __LINE__)

#define FTS_TEST_FUNC_EXIT()  pr_info("[ZTE_LDD_TP_2nd][FTS_TS][TEST](%s,%d): Exit\n", __func__, __LINE__)

#define FTS_TEST_INFO(fmt, args...) pr_info("[ZTE_LDD_TP_2nd][FTS_TS/I][TEST](%s,%d):"fmt"\n", __func__, __LINE__, ##args)

#define FTS_TEST_ERROR(fmt, args...)  pr_err("[ZTE_LDD_TP_2nd][FTS_TS/E][TEST](%s,%d):"fmt"\n", __func__, __LINE__, ##args)
...
#define FTS_TEST_SAVE_ERR(fmt, args...)  do { \
	...
	pr_err("[ZTE_LDD_TP_2nd][FTS_TS/E][TEST](%s,%d):"fmt"\n", __func__, __LINE__, ##args);\
} while (0)

#else
#define FTS_TEST_SAVE_INFO(fmt, args...) do { \
    pr_info("[ZTE_LDD_TP_2nd][FTS_TS/I][TEST](%s,%d):"fmt"\n", __func__, __LINE__, ##args); \
} while (0)
