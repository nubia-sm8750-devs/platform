...
static int ft5572_rawdata_test(struct fts_test *tdata, bool *test_result)
{
    ...
    /* show test data */
    fts_show_data(rawdata, false);

    /* compare */
    result = fts_compare_array(rawdata,
                           thr->rawdata_h_min,
                           thr->rawdata_h_max,
                           false);
...
static int ft5572_uniformity_test(struct fts_test *tdata, bool *test_result)
{
    ...
    if (thr->basic.uniformity_check_tx) {
        ...
        fts_show_data(rl_tmp, false);
        FTS_TEST_SAVE_INFO("\n" );

        /* compare */
        result = fts_compare_array(rl_tmp,
    ...
    if (thr->basic.uniformity_check_rx) {
        ...
        /* compare */
        result2 = fts_compare_array(rl_tmp,
...
static int ft5572_panel_differ_test(struct fts_test *tdata, bool *test_result)
{
    ...
    /* show test data */
    fts_show_data(panel_differ, false);

    /* compare */
    tmp_result = fts_compare_array(panel_differ,
...
static int ft5572_noise_test(struct fts_test *tdata, bool *test_result)
{
    ...
    /* show test data */
    fts_show_data(noise, false);

    /* compare */
    tmp_result = fts_compare_array(noise, thr->noise_min, thr->noise_max, false);
...
static int start_test_ft5572(void)
{
    ...
    if (true == test_item->noise_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_NOISE_TEST_FAIL;
        }
    }
    ...
    if (true == test_item->rawdata_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_RAWDATA_TEST_FAIL;
        }
    }
    ...
    if (true == test_item->rawdata_uniformity_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_UNIFORMITY_TEST_FAIL;
        }
    }
    ...
    if (true == test_item->panel_differ_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_PANEL_DIFF_TEST_FAIL;
        }
    }
    ...
    if (true == test_item->scap_cb_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_CB_TEST_FAIL;
        }
    }
    ...
    if (true == test_item->short_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
            tpd_cdev_2nd->zte_tp_selftest_result_2nd = tpd_cdev_2nd->zte_tp_selftest_result_2nd | TP_SHORT_TEST_FAIL;
        }
    }
