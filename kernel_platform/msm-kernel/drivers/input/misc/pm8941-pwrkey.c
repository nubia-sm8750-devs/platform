...
/* Started by AICoder, pid:acc3bo3a36h495a14b180a09e0d39a9a6ee6837b */
#ifdef CONFIG_ZTE_BOOT_CODE
...
static bool vendor_volume_keys_pressed(struct pm8941_pwrkey *pon) {
    ...
    if (gpio_is_valid(pon->vol_up_gpio)) {
...
#endif
/* Ended by AICoder, pid:acc3bo3a36h495a14b180a09e0d39a9a6ee6837b */
...
/* Started by AICoder, pid:p68491a0343540c14a230bef40e4c4127a30db92 */
#ifdef CONFIG_ZTE_BOOT_CODE
...
#endif
/* Ended by AICoder, pid:p68491a0343540c14a230bef40e4c4127a30db92 */
...
/* Started by AICoder, pid:17a8d66a6d8307e147c7088a502f731e9e42cd21 */
#ifdef CONFIG_ZTE_BOOT_CODE
	if (!strcmp(pwrkey->input->name, "pmic_resin")) {
...
#endif
/* Ended by AICoder, pid:17a8d66a6d8307e147c7088a502f731e9e42cd21 */
