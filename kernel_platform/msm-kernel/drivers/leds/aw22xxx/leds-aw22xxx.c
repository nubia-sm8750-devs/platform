 ...
 ******************************************************/
/* Started by AICoder, pid:w99a9r0a49k7d56141580883302763493ed80bcc */
static void aw22xxx_set_cfg_run_state(int effect) {
    ...
    // touch off
    if (3 == effect) {
        g_cfg_cur_state &= (~BIT_TOUCH_ENABLE);
        return;
    }

    // touch on
    if (0xb == effect || 0xc == effect || 0xd == effect || 0xe == effect) {
        g_cfg_cur_state |= BIT_TOUCH_ENABLE;
        return;
    }
...
/* Ended by AICoder, pid:w99a9r0a49k7d56141580883302763493ed80bcc */
/******************************************************
 *
...
/* Started by AICoder, pid:zdf3cgd9c87e7d714e9f0afeb0c8dc24950759f6 */
...
/* Ended by AICoder, pid:zdf3cgd9c87e7d714e9f0afeb0c8dc24950759f6 */
...
/* Ended by AICoder, pid:te96e546536662c14c2a0a8a40b2ec62ad4426ce */
