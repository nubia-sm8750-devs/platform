...
static ssize_t charging_enabled_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t charging_enabled_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t battery_charging_enabled_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t battery_charging_enabled_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t battery_type_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
	...
	rc = read_property_id(bcdev, pst, BATT_BATTERY_TYPE);
	if (rc < 0)
		return rc;

	return scnprintf(buf, PAGE_SIZE, "%d\n", pst->prop[BATT_BATTERY_TYPE]);
}
static CLASS_ATTR_RO(battery_type);
static ssize_t smb139x_state_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t oem_charger_type_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t oem_battery_type_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t oem_battery_type_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t screen_is_on_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t screen_is_on_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t resistance_id_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t recharge_soc_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t recharge_soc_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t charge_mode_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t charge_mode_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t usb_suspend_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t usb_present_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t adsp_debug_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t adsp_debug_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t ssoc_full_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t ssoc_full_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t rsoc_full_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t rsoc_full_show(const struct class *c, const struct class_attribute *attr,
				char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t batt_pmic_temp_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t batt_smb139x_temp1_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t batt_smb139x_temp2_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t battery_cycle_store(const struct class *c, const struct class_attribute *attr,
				const char *buf, size_t count)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
static ssize_t battery_cycle_show(const struct class *c, const struct class_attribute *attr,
			char *buf)
{
	struct battery_chg_dev *bcdev = container_of(c, struct battery_chg_dev,
						battery_class);
...
*/
		...
		if (rc < 0) {
			...
			return rc;
                ...
                rc = read_property_id(bcdev, pst, BATT_BATTERY_TYPE);
                if(pst->prop[BATT_BATTERY_TYPE] == 2){
                        pr_err("Error in reading qcom,thermal-mitigation BATT_BATTERY_TYPE 2\n");
                        memcpy(&bcdev->thermal_levels[1], array_100w, sizeof(array_100w));
                }else{
                        pr_err("Error in reading qcom,thermal-mitigation BATT_BATTERY_TYPE 1\n");
...
static void battery_chg_update_soc_work(struct work_struct *work)
{
	...
	pr_info("screen_is_on=%d,delay=%lu\n", bcdev->screen_is_on, delay_ms);
