...
int perform_ese_cold_reset(unsigned long arg)
{
	...
	/* Started by AICoder, pid:fef3cm7ce2c508e146410ac810b9d500b7b15903 */
	pr_debug("%s: arg = %d ret = %d\n", __func__, (int)arg, ret);
	/* Ended by AICoder, pid:fef3cm7ce2c508e146410ac810b9d500b7b15903 */
	return ret;
}
