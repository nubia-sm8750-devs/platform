...
static int lpm_test_create_device(struct dwc3_msm *motg)
{
	...
	motg->lpm_test_class = class_create("charger");
...
{
/* Started by AICoder, pid:g8b5dp57e7je0d4146f9095d20dbc11943033816 */
	struct dwc3 *dwc = NULL;
	...
	if (dwc->gadget->speed == USB_SPEED_SUPER_PLUS)
		...
		return scnprintf(buf, PAGE_SIZE, "none\n");
/* Ended by AICoder, pid:g8b5dp57e7je0d4146f9095d20dbc11943033816 */
}
...
#ifdef CONFIG_NUBIA_USB
	nubia_mdwc = mdwc;
	/* Started by AICoder, pid:928dar4ac6xa00d144a4095480b9281839716a06 */
...
/* Ended by AICoder, pid:928dar4ac6xa00d144a4095480b9281839716a06 */
#endif
	return 0;
