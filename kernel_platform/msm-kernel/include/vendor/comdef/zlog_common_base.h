...
#define ZLOG_TP_SERVICE_ERROR_NO			(17 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_TP_OVERLOW_ERROR_NO			(18 | ZLOG_COMB_ERR_FLAG)
...
#define ZLOG_SENSOR_SENSORHUB_ASSERT_NO		(9 | ZLOG_COMB_WARN_FLAG)
#define ZLOG_SENSOR_FALL_DETECTION			(10 | ZLOG_COMB_WARN_FLAG)
#define ZLOG_SENSOR_ALS_LUX_EXCEPTION		(11 | ZLOG_COMB_WARN_FLAG)
...
#define ZLOG_FP_DEFAULT                    (269 | ZLOG_COMB_WARN_FLAG)
...
/* DPTX */
#define ZLOG_DPTX_TRAINING_ERROR_NO				(1 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_DPTX_EDID_ERROR_NO				(2 | ZLOG_COMB_ERR_FLAG)
...
#if IS_ENABLED(CONFIG_VENDOR_ZTE_LOG_EXCEPTION) || IS_ENABLED(CONFIG_VENDOR_ZTE_DEV_MONITOR_SYSTEM)
