...
enum {
	ZTE_LAYER_NONE = 0,
	ZTE_LAYER_DIM = BIT(0),
	ZTE_LAYER_ICON = BIT(1),
	ZTE_LAYER_AOD = BIT(2),
	ZTE_LAYER_EXTENDHDR = BIT(3),
	ZTE_LAYER_HDRVIDEO = BIT(4),
	ZTE_LAYER_SENSOR = BIT(5),
};
#endif
...
struct dsi_panel {
	...
	struct delayed_work hbm_delayed_work;
	struct workqueue_struct *icon_workq;
	struct delayed_work icon_delayed_work;
	u32 set_dim;
