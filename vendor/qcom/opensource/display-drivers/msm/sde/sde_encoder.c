...
#include "../zte_disp/zte_disp_sync_frame.h"
#endif
			...
			enum sde_perf_commit_state commit_state)
{
	...
	if ((commit_state == SDE_PERF_ENABLE_COMMIT) || req_scc) // modify by zte from qualcomm patch
...
#ifdef CONFIG_DRM_ZTE_DISP_FOD
	sde_connector_feed_cmds_sync_frame(sde_enc);
#endif
